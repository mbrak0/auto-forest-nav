...
while goal_reached(true_x_pos, true_z_pos, true_x_goal_pos, true_z_goal_pos) == False:
	...
	if moves_exceeded(move_count) == False:
		...
		if dir_check_count < dir_check_limit:
			f6.write(str(move_count) + ": x: " + str(x_pos) + ", z: " + str(z_pos) + " -> Left mean = " + str(left_mean) + ", Mid mean = " + str(mid_mean) + ", Right mean = " + str(right_mean) + " -> " + str(move_arr[move_count]) + "\n")
		else:
